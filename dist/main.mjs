!(function (e) {
  ...
  function (e, t, n) {
    ...
    function b(e) {
      ((!e.__d && (e.__d = !0) && o.push(e) && !l++) ||
        u !== r.debounceRendering) &&
        ((u = r.debounceRendering) || _)(k);
    }
    function k() {
    ...
    function S(e, t, n, r, o, l, _, u, i) {
      ...
      if (
        ...
        (t.__k = w(t.__k, function (n) {
          if (null != n) {
            ...
            if (
              ...
              else if (l == d || h != u || null == h.parentNode) {
                e: if (null == u || u.parentNode !== e)
                  e.appendChild(h), (c = null);
                else {
                  for (v = u, f = 0; (v = v.nextSibling) && f < k; f += 2)
                    if (v == h) break e;
                  e.insertBefore(h, u), (c = u);
                }
                "option" == t.type && (e.value = "");
              }
              (u = void 0 !== c ? c : h.nextSibling),
        ...
        for (p = l.length; p--; ) null != l[p] && a(l[p]);
      for (p = k; p--; ) null != b[p] && E(b[p], b[p]);
      if (g) for (p = 0; p < g.length; p++) T(g[p], g[++p], g[++p]);
    }
    function w(e, t, n) {
      ...
      if (
        ...
        if (((l = e.style), "string" == typeof n)) l.cssText = n;
          ...
          if (("string" == typeof r && ((l.cssText = ""), (r = null)), r))
            for (_ in r) (n && _ in n) || x(l, _, "");
          if (n) for (u in n) (r && n[u] === r[u]) || x(l, u, n[u]);
        }
      else
        "o" === t[0] && "n" === t[1]
          ? ((i = t !== (t = t.replace(/Capture$/, ""))),
            ...
            n
              ? (r || e.addEventListener(t, C, i), ((e.l || (e.l = {}))[t] = n))
    ...
    function M(e, t, n, o, l, _, u, i, s) {
      ...
      try {
        e: if ("function" == typeof x) {
          if (
            ((b = t.props),
            (k = (c = x.contextType) && o[c.__c]),
            (w = c ? (k ? k.props.value : c.__) : o),
            n.__c
            ...
            if (
              (null == x.getDerivedStateFromProps &&
                ...
                p.componentWillReceiveProps(b, w),
              !p.__e &&
                null != p.shouldComponentUpdate &&
                !1 === p.shouldComponentUpdate(b, p.__s, w))
            ) {
              for (
                p.props = b,
                  p.state = p.__s,
            ...
            null != p.componentWillUpdate && p.componentWillUpdate(b, p.__s, w),
              null != p.componentDidUpdate &&
                p.__h.push(function () {
                  p.componentDidUpdate(d, h, m);
                });
          }
          (p.context = w),
            (p.props = b),
            ...
            a ||
              ...
              (m = p.getSnapshotBeforeUpdate(d, h)),
            S(e, t, n, o, l, _, u, i, s),
            (p.base = t.__e),
            p.__h.length && u.push(p),
            g && (p.__E = p.__ = null),
            (p.__e = !1);
        } else t.__e = D(n.__e, t, n, o, l, _, u, s);
        (c = r.diffed) && c(t);
      } catch (e) {
        r.__e(e, t, n);
      }
    ...
    function D(e, t, n, r, o, l, _, u) {
      ...
      if (null === t.type) h !== v && e.data != v && (e.data = v);
        ...
        (function (e, t, n, r, o) {
          var l;
          for (l in n) l in t || P(e, l, null, n[l], r);
          for (l in t)
          ...
          a || S(e, t, n, r, "foreignObject" !== t.type && o, l, _, s, u),
          u ||
            ("value" in v &&
              void 0 !== v.value &&
              v.value !== e.value &&
    ...
    function E(e, t, n) {
      ...
      if (
        ...
        n || "function" == typeof e.type || (n = null != (l = e.__e)),
        (e.__e = e.__d = void 0),
        null != (o = e.__c))
      ) {
      ...
      if ((o = e.__k)) for (_ = 0; _ < o.length; _++) o[_] && E(o[_], t, n);
      null != l && a(l);
    }
    function U(e, t, n) {
    ...
    function O(e, t, n) {
      ...
      r.__ && r.__(e, t),
        ...
        M(
          ...
          n && !o ? [n] : l ? null : c.slice.call(t.childNodes),
          _,
          n || s,
          o
        ),
    ...
    var j = function (e, t, n, r) {
        ...
        for (var l = 1; l < t.length; l++) {
          var _ = t[l++],
            u = t[l] ? ((t[0] |= _ ? 1 : 2), n[t[l++]]) : t[++l];
          3 === _
            ? (r[0] = u)
            : 4 === _
            ? (r[1] = Object.assign(r[1] || {}, u))
            : 5 === _
            ? ((r[1] = r[1] || {})[t[++l]] = u)
            : 6 === _
            ? (r[1][t[++l]] += u + "")
            : _
            ? ((o = e.apply(u, j(e, u, n, ["", null]))),
              r.push(o),
              u[0] ? (t[0] |= 2) : ((t[l - 2] = 0), (t[l] = o)))
            : r.push(u);
        }
        return r;
      },
