  ...
  function (e, t, n) {
    ...
    function w(e, t, n, r, o, l, _, u, i) {
      ...
      if (
        ...
        (f = 0),
        (t.__k = S(t.__k, function (n) {
          if (null != n) {
            if (
              ((n.__ = t),
              (n.__b = t.__b + 1),
              null === (d = b[f]) || (d && n.key == d.key && n.type === d.type))
            )
              b[f] = void 0;
            else
              for (p = 0; p < k; p++) {
            ...
            if (
              ...
              if ((null == y && (y = h), void 0 !== n.__d))
                ...
                e: if (null == u || u.parentNode !== e)
                  ...
                  for (v = u, p = 0; (v = v.nextSibling) && p < k; p += 2)
                    if (v == h) break e;
        ...
        for (f = l.length; f--; ) null != l[f] && a(l[f]);
      for (f = k; f--; ) null != b[f] && D(b[f], b[f]);
      if (g) for (f = 0; f < g.length; f++) j(g[f], g[++f], g[++f]);
    }
    function S(e, t, n) {
      if ((null == n && (n = []), null == e || "boolean" == typeof e))
        t && n.push(t(null));
      else if (Array.isArray(e))
        for (var r = 0; r < e.length; r++) S(e[r], t, n);
      else
        n.push(
          t
            ? t(
        ...
        e: if ("function" == typeof x) {
          if (
            ...
            null != x.getDerivedStateFromProps &&
              ...
              p(f.__s, x.getDerivedStateFromProps(b, f.__s))),
            (d = f.props),
            (h = f.state),
            a)
          )
          ...
          (f.context = S),
            ...
            g && (f.__E = f.__ = null),
            (f.__e = !1);
        } else t.__e = O(n.__e, t, n, o, l, _, u, s);
        (c = r.diffed) && c(t);
      } catch (e) {
        r.__e(e, t, n);
      }
    ...
    function O(e, t, n, r, o, l, _, u) {
      ...
      if (null === t.type) h !== v && e.data != v && (e.data = v);
        ...
        (function (e, t, n, r, o) {
          ...
          a || w(e, t, n, r, "foreignObject" !== t.type && o, l, _, s, u),
          u ||
            ("value" in v &&
              void 0 !== v.value &&
              v.value !== e.value &&
    ...
    function D(e, t, n) {
      ...
      if (
        ...
        (o = e.ref) && ((o.current && o.current !== e.__e) || j(o, null, t)),
      ...
      if ((o = e.__k)) for (_ = 0; _ < o.length; _++) o[_] && D(o[_], t, n);
      null != l && a(l);
    }
    function T(e, t, n) {
